...
| <a name="input_create_iam_role"></a> [create\_iam\_role](#input\_create\_iam\_role) | Whether to create an IAM role resource | `bool` | `false` | no |
...
| <a name="input_deploy_service"></a> [deploy\_service](#input\_deploy\_service) | Use this to use or not terraform to deploy a service, boolean value | `bool` | `false` | no |
...
| <a name="input_ecs_create_task_execution_role"></a> [ecs\_create\_task\_execution\_role](#input\_ecs\_create\_task\_execution\_role) | Set to true to create ecs task execution role to ECS Tasks. | `bool` | `false` | no |
